...
material = Material(name="EN 10028-2 Grade 10CrMo9-10 normalized and tempered (+NT)", category=category, mat_id=40810028, 
...
material = register_material(token, material)

category = get_category_by_name("Other")

material2 = Material("Example Material", category=category, mat_id=123456, source="The source of the material.",
                     heat_treatment="The heat treatment of the material.", description="Material description.",
                     designation="ABCDEFG")

material2 = register_material(token, material2)

print(material.id, material.name, material.user, material.date)
print(material2.id, material2.name, material2.user, material2.date)
