# Generated by Django 4.1.3 on 2023-02-23 10:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ambient_temperature', models.DecimalField(decimal_places=2, max_digits=5, null=True)),
                ('load', models.DecimalField(decimal_places=2, max_digits=5, null=True)),
                ('test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='API_Materials.test')),
            ],
            options={
                'unique_together': {('test', 'stage_num')},
